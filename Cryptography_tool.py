...
subparser = parser.add_subparsers(title="Subcommands", dest="command", help="Available Commands!")
...
parser_encrypt.add_argument("-k", "--key", help="Enter the name of the file containing the cryptography key", default="generated.key")
...
parser_decrypt.add_argument("-k", "--key", help="Enter the name of the file containing the cryptography key", default="generated.key")
